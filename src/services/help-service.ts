...
export const NODE_DESCRIPTIONS: INodeDescription = {
  ...
  GATHER: `is used perform a parallel execution. The portion of the plan below it will run in parallel.`,
  "GATHER MERGE": `is used perform a parallel execution and merging the results. The portion of the plan below it will run in parallel.`,
}
